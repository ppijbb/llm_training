"""
Example usage of SPECTRA (Gram Matrix-based Specialization Routing)

This module demonstrates how to convert any pretrained HuggingFace model
into a Mixture of Experts (MoE) model using SPECTRARouter routing method.
SPECTRA uses Gram matrix-based orthogonal constraints for expert specialization
and diversity.
"""
import os
import time
...
from models.spectra import upcycle_model_to_moe, SPECTRARouter
...
# from models.spectra_wrapper import enable_global_routing_state
...
if __name__ == "__main__":
    print("=" * 60)
    print("SPECTRA Upcycling Examples")
