...
class SPECTRATextConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        bias_max=3.0,
        lb_bias_coef=1.0,
        bias_predictor_hidden_dim=256,
        uncertainty_threshold=0.7,
        enable_uncertainty_broadcast=True,
        strength_variance_coef=0.001,
        remove_lbl=True,
        router_dim=128,
        ...
        **kwargs,
        ...
        self.lb_bias_coef = lb_bias_coef
        self.bias_predictor_hidden_dim = bias_predictor_hidden_dim
        self.uncertainty_threshold = uncertainty_threshold
        self.enable_uncertainty_broadcast = enable_uncertainty_broadcast
        self.strength_variance_coef = strength_variance_coef
        self.remove_lbl = remove_lbl
